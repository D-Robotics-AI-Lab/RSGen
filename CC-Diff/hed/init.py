...
class HEDdetector:
    ...
    def from_pretrained(cls, pretrained_model_or_path=HF_MODEL_NAME, filename="ControlNetHED.pth"):
        ...
        netNetwork.load_state_dict(torch.load('./ckpts/lllyasviel/Annotators/ControlNetHED.pth', map_location='cpu'))
    ...
    def __call__(self, input_image, detect_resolution=512, safe=False, output_type="pil", scribble=False, upscale_method="INTER_CUBIC", **kwargs):
        ...
        # input_image, remove_pad = resize_image_with_pad(input_image, detect_resolution, upscale_method)  #remove for ori size
