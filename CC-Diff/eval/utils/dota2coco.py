...
wordname_15 = ["plane","ship","storage-tank","baseball-diamond","tennis-court",
...
if __name__ == '__main__':
    DOTA2COCO(r'/data/vepfs/users/xianbao01.hou/CC-Diff/dataset/filter_val', r'/data/vepfs/users/xianbao01.hou/CC-Diff/dataset/filter_val/val_obbox.json')