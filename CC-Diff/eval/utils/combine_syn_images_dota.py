...
if __name__ == '__main__':
    ...
    # new_img_dir = '/data/vepfs/users/xianbao01.hou/CC-Diff/hbbox_ori_cnet_xs_finetune_w_mask_w_gated_train_wo_edge2edge/raw'                             # synthesized images path
    # output_json = '/data/vepfs/users/xianbao01.hou/ccdiff_datasets/RSVG/hbbox_ori_cnet_xs_finetune_w_mask_w_gated_train_wo_edge2edge/combined_train_annotations.json'        # combined json save path
    # combined_img_dir = '/data/vepfs/users/xianbao01.hou/ccdiff_datasets/RSVG/hbbox_ori_cnet_xs_finetune_w_mask_w_gated_train_wo_edge2edge/combined_train'                    # combined images path (original & synthesized images)
    ...
    new_img_dir = '/data/vepfs/users/xianbao01.hou/FICGen/ficgen_gen_ori_obbox_dota_wo_fgcnet_wo_edge2edge_train/raw'                             # synthesized images path
    output_json = '/data/vepfs/users/xianbao01.hou/ccdiff_datasets/DOTA/ficgen_gen_ori_obbox_dota_wo_fgcnet_wo_edge2edge_train/combined_train_annotations.json'        # combined json save path
    combined_img_dir = '/data/vepfs/users/xianbao01.hou/ccdiff_datasets/DOTA/ficgen_gen_ori_obbox_dota_wo_fgcnet_wo_edge2edge_train/combined_train'                    # combined images path (original & synthesized images)
    update_coco_with_new_jsonl_and_images(existing_coco_json, meta_path, img_dir, new_img_dir, output_json, combined_img_dir)
