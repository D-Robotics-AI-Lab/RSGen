...
from paths import DOTA_IMAGES_TRAIN, DOTA_TRAIN_HED
...
# ================= config =================
# Input: folder of source RGB images
IMAGE_BASE_DIR = DOTA_IMAGES_TRAIN

# Output: full-image HED maps
OUTPUT_DIR = DOTA_TRAIN_HED
...
def hed_pred(image, device):
    """PIL Image in, HED edge map as PIL Image out."""
